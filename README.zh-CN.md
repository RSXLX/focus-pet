...
- 当前版本：[v1.0.3](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.3)
...
最新版本：[v1.0.3](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.3)

| 平台 | 下载 | 说明 |
| --- | --- | --- |
| macOS Apple Silicon | [Release assets](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.3) | 下载 DMG，包含完整桌宠应用。 |
| macOS Apple Silicon | [Release assets](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.3) | 也提供 ZIP 归档。 |
| 校验信息 | [Release assets](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.3) | 包含 SHA-256 manifest。 |
...
- 可选屏幕检查：默认关闭；可通过 Focus Pet Cloud 作为后端 StepFun 代理，让下载版 App 不内置 API key；仅在用户明确开启或手动测试后，才发送低细节截图到视觉模型。
- 可选本地社交聊天：支持邀请链接、网页客户端、媒体消息、宠物 GIF 和 WebRTC 信令。
- 可选 Focus Pet Cloud 后端：支持稳定用户 ID、好友码、认证 WebSocket 信令、两个人一对一 WebRTC 语音/视频通话，以及后端屏幕检查代理。
...
| 发布说明 | [docs/releases/v1.0.3.md](docs/releases/v1.0.3.md) |
