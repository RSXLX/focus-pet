...
- 当前版本：[v1.0.1](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.1)
...
最新版本：[v1.0.1](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.1)

| 平台 | 下载 | 说明 |
| --- | --- | --- |
| macOS Apple Silicon | [Release assets](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.1) | 下载 DMG 用于普通安装。 |
| macOS Apple Silicon | [Release assets](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.1) | 也提供 ZIP 归档。 |
| 校验信息 | [Release assets](https://github.com/RSXLX/focus-pet/releases/tag/v1.0.1) | 包含 SHA-256 manifest。 |
...
| 发布说明 | [docs/releases/v1.0.1.md](docs/releases/v1.0.1.md) |
